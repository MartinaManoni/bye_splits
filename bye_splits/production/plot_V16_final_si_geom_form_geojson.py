#Plotting final V16 geometry for eta>0 and eta < 0 from geojson file 
...
def plot_geojson_figures(geojson_file, eta_type):
    ...
    output_dir = f'plots_geojson_V16_ETA_{eta_type}'
...
def main():
    ...
    eta_type = input("Enter the plot type ('LT0' for eta<0, 'GT0' for eta>0): ").strip().upper()
